...
import ru.kulakova.commands.lists.ListByAuthorCommand;
import ru.kulakova.controllers.LibraryController;
import ru.kulakova.handlers.BaseHandler;

public class ListByAuthorHandler extends BaseHandler {

    private static final String COMMAND_NAME = "author";

    public ListByAuthorHandler(LibraryController controller) {
        super(controller);
    }
    ...
    public Commanding handle(String command, String args) {
        ...
        return new ListByAuthorCommand(_controller);
    }
}
